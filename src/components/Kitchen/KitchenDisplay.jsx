...
import { Clock, CheckCircle, ChefHat, Utensils, Coffee, Timer } from 'lucide-react'
    ...
    const fetchKitchenOrders = async () => {
      try {
        const { data, error } = await supabase
          ...
          `)
          .in('products.categories.printer_destination', ['kitchen', 'grill'])
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Comandas y preparación</p>
          </div>
        </div>
      ...
      <div className="space-y-6">
        {Object.values(groupedOrders).map((order) => (
          <div key={order.id} className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="flex justify-between items-start mb-4 pb-4 border-b">
              ...
              <div className="flex items-center gap-2">
                {order.tables?.areas?.name === 'interior' && <Utensils className="w-5 h-5 text-gray-400" />}
                {order.tables?.areas?.name === 'terraza' && <Coffee className="w-5 h-5 text-gray-400" />}
        ...
        {Object.keys(groupedOrders).length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-600">No hay comandas pendientes</p>
