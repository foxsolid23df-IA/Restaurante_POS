  ...
  if (products.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-10 text-slate-300">
        ...
        <p className="text-xl font-black tracking-tight text-primary uppercase font-display">Sin productos disponibles</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-5">
        {products.map((product) => (
          <button
            ...
            className="premium-card p-4 group flex flex-col h-full bg-white opacity-0 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-forwards"
          >
            <div className="h-40 bg-slate-50 rounded-2xl mb-5 overflow-hidden flex items-center justify-center relative shadow-inner group-hover:shadow-none transition-all">
              {product.image_url ? (
              ...
              {product.hasLowStock && (
                <span className="absolute top-3 left-3 rounded-lg bg-amber-100 px-2 py-1 text-[9px] font-black uppercase tracking-widest text-amber-800">
                  Stock
                </span>
              )}
            </div>
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                ...
                <div className="w-10 h-10 flex items-center justify-center bg-slate-50 rounded-2xl text-secondary group-hover:bg-secondary group-hover:text-white transition-all duration-300 shadow-sm shadow-blue-500/5 group-active:scale-90">
